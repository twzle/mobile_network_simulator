...
DefaultDRRSchedulerWithUserQuant::DefaultDRRSchedulerWithUserQuant()
    : BaseRRScheduler() {};
...
int DefaultDRRSchedulerWithUserQuant::get_next_initial_queue()
{
    return last_starving_queue;
}

// Сохранение последней недообслуженной очереди
void DefaultDRRSchedulerWithUserQuant::set_last_starving_queue(int last_starving_queue)
{
    this->last_starving_queue = last_starving_queue;
}

// Обновление дефицитов пользователей
void DefaultDRRSchedulerWithUserQuant::update_users_deficit()
{
