...
public:
    ...
    double scheduler_average_total_time = 0; // Среднее время работы на очередь
    ...
    double scheduler_average_processing_time = 0; // Среднее время облуживания на очередь
    ...
    double scheduler_average_idle_time = 0; // Среднее время простоя на очередь
    ...
    double scheduler_average_wait_time = 0; // Среднее время бездействия на очередь
